                    ...
                    <div id="esquerda" style="width: 50%;float:left;">
                        <div class="label" style="heigth:300px">
                            ...
                            <div style="  height: 300px;    width: 200px;    float: left;   ">
                                ...
                                <input type="text" value= "" name="datasaida" size="30" placeholder=" Hoje" disabled><br>

                                <input type="text" value= "" name="status" size="30" placeholder="Pendente" disabled><br>

                                <input type="date" value= "" name="dataprev" size="30" style="margin-top: 5px;"><br><br>
                                ...
                                <select name="referencia" id="referencia" style="margin-top: 5px;">
