...
<head>
    ...
    if( isset($_POST['nome']) )
    {
      //  var_dump($_REQUEST);
        ...
        $sql = "INSERT INTO referencia (idreferencia, codigoref,nomereferencia,status) VALUES (NULL, '$codigo','$nome',0);"; 
            ...
            <div class="interna" style="text-aling:left;">
                ...
                <form name="cadreferencia" action="novareferencia.php" method="post" id="cadreferencia">
                    ...
                    <div style="width:200px;height:150px;float:left;">
                        <input type="text" required name="codigoref" size="40" placeholder="Ex: 14A7">
                        <input type="text" required name="nome" size="40" placeholder="Ex: Blusa">
                        ...
                        <select required name="operacaoop" id="operacaoop">
