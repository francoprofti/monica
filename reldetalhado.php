...
<head>
    ...
    <?php
        ...
        $sql = "SELECT operacao.codigo, operacao.nomeoperacao,ordemservico.idordemservico AS id, ordemservico.datacriacao as data, faccionista.nomefac as faccionista, ordemservico.idreferencia, ordemservico.qnt, ordemservico.modelo, ordemservico.obs, referencia.codigoref,ordemoperacao.valor FROM ordemservico INNER JOIN faccionista ON (ordemservico.idfaccionista = faccionista.idfaccionista) INNER JOIN ordemoperacao ON (ordemservico.idordemservico = ordemoperacao.idordemservico) INNER JOIN operacao ON (ordemoperacao.idoperacao = operacao.idoperacao) INNER JOIN referencia ON (ordemservico.idreferencia = referencia.idreferencia)  
...
<body>
    <table>
        <tr style="text-align:center;">
            ...
            <th style="width:50px;">Cod.Op.:</th>
            <th style="max-width:200px;">Operação</th>
    ...
    ?>
                    <tr style="background: <?php echo $cor?>;">
                        ...
                        <td style="text-align:center;"><?php echo $codop ;?></td>
                        <td style="text-align:left;max-width:200px;"><?php echo $nomeop ;?></td>
    ...
    <?php
             ...
             echo "</table>";
             echo "<h3 style='margin-left: 810px;'>TOTAL: R$ ".number_format($totalfinal,2,",",".")."</h3>";
    ?>
